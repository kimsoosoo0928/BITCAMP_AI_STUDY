...
'''
restore_best_weights=False <- 디폴트값 
==========================1. 기본출력 ======================
1/1 [==============================] - 0s 172ms/step - loss: 0.4702 - mae: 0.2572       
loss :  0.47021013498306274
r2스코어 :  0.9994622373112025
==========================2. load_model ======================
1/1 [==============================] - 0s 193ms/step - loss: 0.4702 - mae: 0.2572       
loss :  0.47021013498306274
r2스코어 :  0.9994622373112025
==========================3. Model Check Point ======================
1/1 [==============================] - 0s 185ms/step - loss: 0.4718 - mae: 0.2925       
loss :  0.471798837184906
r2스코어 :  0.9994604203729848


restore_best_weights=True
==========================1. 기본출력 ======================
1/1 [==============================] - 0s 167ms/step - loss: 0.0019 - mae: 0.0272       
loss :  0.0018896347610279918
r2스코어 :  0.9999978388916138
==========================2. load_model ======================
1/1 [==============================] - 0s 174ms/step - loss: 0.0019 - mae: 0.0272       
loss :  0.0018896347610279918
r2스코어 :  0.9999978388916138
==========================3. Model Check Point ======================
1/1 [==============================] - 0s 187ms/step - loss: 0.0012 - mae: 0.0134       
loss :  0.0011884297709912062
r2스코어 :  0.9999986408348805
'''
