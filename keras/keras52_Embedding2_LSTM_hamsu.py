...
input1 = Input(shape=(5,)) # input layer (13,5)
input1 = Input(shape=(None,))
em = Embedding(input_dim=28, output_dim=77, input_length=5)(input1)
em = LSTM(units=32, activation='relu')(em)
output = Dense(1, activation='relu')(em)

model = models(inputs=input, outputs=output)
