...
x_train = np.load('./_save/_npy/k55_x_data_train_mnist.npy')
x_test = np.load('./_save/_npy/k55_x_data_test_mnist.npy')
y_train = np.load('./_save/_npy/k55_y_data_train_mnist.npy')
y_test = np.load('./_save/_npy/k55_y_data_test_mnist.npy')
