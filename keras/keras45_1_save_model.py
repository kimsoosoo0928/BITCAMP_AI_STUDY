...
#! 모델 저장 (필요없는것은 주석 처리 한 후 실행) - 경로 잘 확인
#! 확장자는 h5 이다.
#^ 모델만 저장한것이다. (가중치 저장 안했다.)
...
hist = model.fit(x_train, y_train, epochs=100, batch_size=2, callbacks=[es],validation_split=0.25, verbose=2)
