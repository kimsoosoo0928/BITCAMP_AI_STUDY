...
x_train = np.load('./_save/_npy/k55_x_data_train_cifar10.npy')
x_test = np.load('./_save/_npy/k55_x_data_test_cifar10.npy')
y_train = np.load('./_save/_npy/k55_y_data_train_cifar10.npy')
y_test = np.load('./_save/_npy/k55_y_data_test_cifar10.npy')
