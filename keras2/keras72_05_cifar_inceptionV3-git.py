...
# 2. 모델
inceptionv3 = InceptionV3(weights='imagenet', include_top=False, input_shape=(32,32,3))   # include_top=False : input_shape 조정 가능

inceptionv3.trainable=True   # False: vgg훈련을 동결한다(True가 default)
