...
MCPpath = "".join([filepath, "k47_", date_time, "_", filename])
####################################################################

mcp = ModelCheckpoint(monitor='val_loss', save_best_only=True, verbose=1, mode='auto', filepath = MCPpath)

start_time = time.time()
hist = model.fit([x1_train, x2_train], y_train, epochs=10, batch_size=256, verbose=1, callbacks=[es, mcp], validation_split=0.2)
